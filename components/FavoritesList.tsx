...
const FavoritesList: React.FC<FavoritesListProps> = ({ favorites, onToggleFavorite }) => {
  if (favorites.length === 0) {
    return (
      <div className="text-center py-32 bg-stone-100/50 rounded-none border border-black border-dashed">
        <div className="w-20 h-20 bg-white rounded-none border border-black flex items-center justify-center mx-auto mb-6 text-stone-200 shadow-none">
