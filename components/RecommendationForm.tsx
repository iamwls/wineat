...
import SommelierLoader from './SommelierLoader';
...
const RecommendationForm: React.FC<RecommendationFormProps> = ({ onResults, setIsLoading, isLoading, onStepChange }) => {
  ...
  return (
    ...
    >
      {isLoading ? (
        <div className="flex flex-col items-center justify-center flex-grow py-8 animate-in fade-in duration-700">
          <SommelierLoader isEmbedded />
        </div>
      ) : (
        <>
          {step === 1 && (
